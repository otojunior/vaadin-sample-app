package br.org.otojunior.vaadin.sample.views.inserção;
...
@Route(value = "inserir", layout = MainView.class)
@PageTitle("Inserção")
@CssImport("./styles/views/inserção/inserção-view.css")
public class InserçãoView extends Div {
