package br.org.otojunior.vaadin.sample.views.listagem;
...
@Route(value = "listar", layout = MainView.class)
@PageTitle("Listagem")
@CssImport(value = "./styles/views/listagem/listagem-view.css", include="lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class ListagemView extends Div {
